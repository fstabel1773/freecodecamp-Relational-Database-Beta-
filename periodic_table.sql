...
--
-- Name: elements elt_unique; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT elt_unique UNIQUE (symbol);


--
-- Name: elements elt_unique_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT elt_unique_name UNIQUE (name);
